...
/**
 * Seed posts (데모)
 * - localStorage 글과 merge되어 목록에 함께 노출됩니다.
 */
export const MOCK_POSTS: Post[] = [
  ...
  },
  {
    ...
    extra: { topic: "driver", env: "Windows 11 / RTX 40 / Driver 55x", ref: "https://example.com" },
  },
  {
    id: "seed-res-1",
    boardKey: "resources",
    ...
    content:
      "자주 쓰는 모니터링 툴 링크 모음(샘플)입니다. 가능하면 공식 배포처만 공유해주세요.",
    createdAt: iso(60 * 1),
    authorName: "블루딜러-3301",
    extra: { kind: "monitoring", link: "https://example.com", note: "온도/전력/클럭 확인" },
  },
