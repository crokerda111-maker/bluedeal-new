...
function Dropdown({
  ...
  return (
    <div className="relative group">
      ...
      <div className="pointer-events-none absolute left-0 top-full z-50 mt-2 w-56 rounded-2xl border border-white/10 bg-[#060B1A]/95 p-2 shadow-[0_20px_60px_-30px_rgba(0,0,0,0.7)] opacity-0 transition group-hover:pointer-events-auto group-hover:opacity-100">
        {children}
      </div>
    </div>
  );
