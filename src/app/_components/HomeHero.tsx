      ...
      <div className="grid gap-6 md:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_34px_90px_-56px_rgba(59,130,246,0.7)] md:p-8">
          <div className="flex flex-wrap gap-2">
            <Pill tone="cyan">실시간 게시글</Pill>
            <Pill tone="muted">가격현황 09:00 / 17:00</Pill>
            <Pill tone="muted">핫딜 요약</Pill>
          </div>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-white/70 md:text-base">
            IT 소식·커뮤니티·가격현황·핫딜을 한 화면에서 정리합니다. 메인에서는 제휴/외부 링크를 숨기고, 글 상세에서만
            안내합니다.
          </p>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-3">
            <Stat k="게시글" v="실시간" d="IT + 커뮤니티 최신" />
            <Stat k="가격현황" v="09/17시" d="하루 2회 갱신" />
            <Stat k="핫딜" v="링크 최소" d="상세에서만 안내" />
          </div>
        </div>
        ...
        <aside className="rounded-3xl border border-white/10 bg-white/5 p-6 md:p-7">
          ...
          <div className="mt-6 rounded-2xl border border-white/10 bg-[#050816]/60 p-4">
            ...
            <div className="mt-3 space-y-1 text-xs text-white/65">
              <div>• 램, CPU, 그래픽카드, 메인보드, 쿨러</div>
              <div>• 반본체 / 완본체 현황 추가</div>
              <div>• 제휴 표기는 글 상세에서만 노출</div>
            </div>
            ...
            <div className="mt-3 text-[11px] text-white/45">
              * 운영 단계에서 크롤링/수집은 서버(VPS)로 분리하고, 사이트는 표시/정리 중심으로 가는 구성이 안전합니다.
            </div>
          </div>
        </aside>
      </div>
