    ...
    <footer className="border-t border-white/10 py-8">
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 text-sm text-white/60 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          <Link className="hover:text-white" href="/policy/terms">
            이용약관
          </Link>
          <Link className="hover:text-white" href="/policy/privacy">
            개인정보처리방침
          </Link>
        </div>
      </div>
      ...
      <div className="mx-auto mt-4 max-w-6xl px-4 text-[12px] text-white/45">
        일부 링크는 제휴 링크일 수 있으며, 구매가 발생하면 일정 수수료를 받을 수 있습니다. 가격/재고는 수시로 변동될 수 있습니다.
      </div>
    </footer>
  );
}
